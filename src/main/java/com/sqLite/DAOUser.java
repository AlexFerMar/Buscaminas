...
public class DAOUser {
    ...
    public ArrayList<User> select() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                userList.add(new User(result.getString("idUsuario"), result.getString("nomUsuario"), "********"));
            }
    ...
    public User get(String id) {
        ...
        try {
            ...
            if (result.next())
                u = new User(result.getString("idUsuario"), result.getString("nomUsuario"), result.getString("conUsuario"));
